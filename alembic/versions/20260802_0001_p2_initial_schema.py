...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('workspace_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('workspaces.id', ondelete='CASCADE'), nullable=False),
        sa.Column('source_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('sources.id', ondelete='CASCADE'), nullable=False),
        sa.Column('corpus_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('corpora.id', ondelete='SET NULL'), nullable=True),
        sa.Column('external_id', sa.String(length=255), nullable=False),
    ...
    op.create_table(
        'dead_letters',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('job_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('processing_jobs.id', ondelete='SET NULL'), nullable=True),
        sa.Column('workspace_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('workspaces.id', ondelete='CASCADE'), nullable=False),
